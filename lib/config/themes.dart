...
abstract class PingmeThemes {
  ...
  static bool isThreeColumnMode(BuildContext context) =>
      MediaQuery.of(context).size.width > PingmeThemes.columnWidth * 3.5;
  ...
  static ThemeData buildTheme(
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        toolbarHeight: PingmeThemes.isColumnMode(context) ? 72 : 56,
        shadowColor: PingmeThemes.isColumnMode(context)
            ? colorScheme.surfaceContainer.withAlpha(128)
            : null,
        surfaceTintColor:
            PingmeThemes.isColumnMode(context) ? colorScheme.surface : null,
        backgroundColor:
            PingmeThemes.isColumnMode(context) ? colorScheme.surface : null,
      ...
      snackBarTheme: PingmeThemes.isColumnMode(context)
          ? const SnackBarThemeData(
              behavior: SnackBarBehavior.floating,
              width: PingmeThemes.columnWidth * 1.5,
            )

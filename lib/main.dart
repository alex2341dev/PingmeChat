...
import 'package:pingmechat/pages/homeserver_picker/homeserver_auto_picker.dart';
...
import 'package:pingmechat/widgets/error_widget.dart';
...
Future<void> startGui(
  ...
  ErrorWidget.builder = (details) => PingmeChatErrorWidget(details);
  runApp(PingmeChatApp(clients: clients, store: store));

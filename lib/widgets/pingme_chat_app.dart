...
import 'package:pingmechat/config/routes.dart';
import 'package:pingmechat/config/themes.dart';
import 'package:pingmechat/widgets/app_lock.dart';
import 'package:pingmechat/widgets/theme_builder.dart';
...
class PingmeChatApp extends StatelessWidget {
    ...
    return MultiProvider(
      ...
      child: ThemeBuilder(
        builder: (context, themeMode, primaryColor) => MaterialApp.router(
          ...
          themeMode: themeMode,
          theme: PingmeThemes.buildTheme(
            context,
            Brightness.light,
            primaryColor,
          ),
          darkTheme: PingmeThemes.buildTheme(
            context,
            Brightness.dark,
            primaryColor,
          ),

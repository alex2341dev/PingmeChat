...
class _callPageState extends State<_callPage> {
  ...
  void initState() {
    ...
    if (info != null) {
      ...
      callStartTime = info!.history
          .firstWhere((h) => h["state"] == CallState.kConnected)["time"];
    }

    callEventsListen =
        Matrix.of(navigatorKey.currentContext!).callManager!.events.listen((e) {
      if (!mounted) return;
  ...
  void _mute() {
    setState(() {
      Matrix.of(navigatorKey.currentContext!)
          .callManager!
          .setMute(!info!.session.isMicrophoneMuted);
    });
  }
    ...
    final avatars = [
      Expanded(
        child: Container(
          ...
          margin: PlatformInfos.isMobile
              ? const EdgeInsets.only(bottom: 8)
              : const EdgeInsets.only(right: 8),
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(20),
            color: Color.lerp(
              (Matrix.of(navigatorKey.currentContext!).client.userID!.localpart)
                  ?.lightColorAvatar,
              Colors.white,
              0.25,
            )!,
          ...
          child: FutureBuilder<Profile>(
            future: Matrix.of(navigatorKey.currentContext!)
                .client
                .fetchOwnProfile(),
          ...
          Container(
            ...
            child: Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .titleLarge!
                  .copyWith(color: const Color.fromARGB(255, 199, 199, 199)),
            ),
          ),
          Expanded(
            child: SizedBox(
              ...
              if (_inputs.isNotEmpty) ...[
                ...
                ..._inputs.map(
                  (d) => ListTile(
                    ...
                    trailing: d.deviceId == _selectedInput
              ...
              if (_outputs.isNotEmpty) ...[
                ...
                ..._outputs.map(
                  (d) => ListTile(
                    ...
                    trailing: d.deviceId == _selectedOutput
                        ? const Icon(Icons.check)
                        : null,
                    onTap: () {

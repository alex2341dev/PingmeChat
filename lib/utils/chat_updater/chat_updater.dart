  ...
  static Future<void> startUpdate() async {
    try {
      if (PlatformInfos.isWindows) {
        ...
        final tempDirectory = await getTemporaryDirectory();
        final installersDir = Directory('${tempDirectory.path}/installers');
        final archivePath = '${installersDir.path}/${serverVersions!.versions["linux"]!}';
        final scriptPath = '${installersDir.path}/install_update.sh';
        final downloadUrl = "${AppConfig.updateServerUrl}/installers/${serverVersions!.versions["linux"]!}";

...
AppName=PingmeChat
AppVersion=1.0
DefaultDirName={pf}\PingmeChat
DefaultGroupName=PingmeChat
OutputDir=Output
OutputBaseFilename=PingmeChatInstaller
Compression=lzma
...
[Icons]
Name: "{group}\PingmeChat"; Filename: "{app}\pingmechat.exe"
Name: "{commondesktop}\PingmeChat"; Filename: "{app}\pingmechat.exe"
...
[Run]
Filename: "{app}\pingmechat.exe"; Description: "{cm:LaunchProgram,PingmeChat}"; Flags: nowait postinstall skipifsilent
